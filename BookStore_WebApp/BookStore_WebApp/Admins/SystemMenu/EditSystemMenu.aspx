<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSystemMenu.aspx.cs" Inherits="BookStore.WebApp.Admins.SystemMenu.EditSystemMenu" %>
...
<head runat="server">
    ...
    <title>EditSystemMenu ---- 编辑系统菜单信息</title>
    <link href="../css/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="formEditSystemMenu" runat="server">
         <div class="place">
            <span>位置：</span>
            <ul class="placeul">
        ...
        <div class="formbody">
            <div class="formtitle"><span>编辑系统菜单信息</span></div>
            <ul class="forminfo">
                <li>
                    <label>菜单名称</label>
                    <asp:TextBox ID="MenuId" runat="server" ReadOnly="True" CssClass="dfinput"></asp:TextBox>
                </li>
                <li>
                    <label>菜单名称</label>
                    <asp:TextBox ID="MenuTitle" runat="server" CssClass="dfinput"></asp:TextBox>
                    <i>*必须填写
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="角色名称不能为空" ControlToValidate="MenuTitle" Display="Dynamic"></asp:RequiredFieldValidator>
                    </i>
                </li>
                <li>
                    <label>菜单连接</label>
                    ...
                    <i>
                        *必须填写
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="角色名称不能为空" ControlToValidate="MenuLink" Display="Dynamic"></asp:RequiredFieldValidator>
                    </i>
                </li>
                <li>
                    <label>菜单等级:</label>
